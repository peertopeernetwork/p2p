...
(function() {
  ...
  P2PWebSocket = (function() {
    function P2PWebSocket(url) {
    ...
    P2PWebSocket.prototype.init = function() {
      return this;
    };

    P2PWebSocket.prototype.connect = function() {
    ...
    P2PWebSocket.prototype.onMessage = function(e) {
      var cmd, message;
    ...
    P2PWebSocket.prototype.route = function(cmd, message) {
      return this.log("Unknown command", message);
    };

    P2PWebSocket.prototype.response = function(to, result) {
      return this.send({
        "cmd": "response",
        "to": to,
        "result": result
    ...
    P2PWebSocket.prototype.cmd = function(cmd, params, cb) {
      if (params == null) {
        params = {};
      }
      if (cb == null) {
    ...
    P2PWebSocket.prototype.send = function(message, cb) {
      if (cb == null) {
        cb = null;
      }
      if (message.id == null) {
    ...
    P2PWebSocket.prototype.log = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return console.log.apply(console, ["[P2PWebSocket]"].concat(slice.call(args)));
    };

    P2PWebSocket.prototype.onOpenWebsocket = function(e) {
    ...
    P2PWebSocket.prototype.onErrorWebsocket = function(e) {
      this.log("Error", e);
    ...
    P2PWebSocket.prototype.onCloseWebsocket = function(e, reconnect) {
      if (reconnect == null) {
        reconnect = 10000;
      }
      this.log("Closed", e);
  ...
  window.P2PWebSocket = P2PWebSocket;
  ...
  Fixbutton = (function() {
    function Fixbutton() {
      ...
      $(".fixbutton-bg").on("mouseover", function() {
        ...
        $(".fixbutton-document").stop().animate({
          "opacity": 1.5,
          "left": 0
        }, 800, "easeOutElastic");
        return $(".fixbutton-p2p").stop().animate({
          "opacity": 0,
          "left": 20
        }, 300, "easeOutCubic");
      });
    ...
    Loading.prototype.showTrackerTorBridge = function(server_info) {
      ...
      if ($(".console .button-settrackerbridge").length === 0 && !server_info.tor_use_meek_bridges) {
        ...
        if (!server_info.tor_has_meek_bridges) {
          ...
          return this.printLine("No meek bridge support in your client, please <a href='https://github.com/peertopeernetwork/p2p#meek'>set it up</a>.", "warning");
        }
      }
    };
...
(function() {
  ...
  Wrapper = (function() {
    function Wrapper(ws_url) {
      ...
      this.ws = new P2PWebSocket(ws_url);
    ...
    Wrapper.prototype.onPageLoad = function(e) {
      ...
      if (this.ws.ws.readyState === 1 && !this.site_info) {
        ...
        window.document.title = this.site_info.content.title + " - Peer-to-Peer Network";
      ...
      return this.ws.cmd("siteInfo", params, (function(_this) {
        return function(site_info) {
          ...
          if ((((ref = site_info.content) != null ? ref.title : void 0) != null) && !_this.is_title_changed) {
            window.document.title = site_info.content.title + " - Peer-to-Peer Network";
  ...
  ws_url = proto.ws + ":" + origin.replace(proto.http + ":", "") + "/Peer-to-Peer-Network-Internal/Websocket?wrapper_key=" + window.wrapper_key;
...
(function() {
  ...
  WrapperP2PFrame = (function() {
    function WrapperP2PFrame(wrapper) {
      ...
      console.log("WrapperP2PFrame", wrapper);
    }

    WrapperP2PFrame.prototype.cmd = function(cmd, params, cb) {
      if (params == null) {
        params = {};
      }
      if (cb == null) {
    ...
    WrapperP2PFrame.prototype.response = function(to, result) {
      return this.wrapperResponse(to, result);
    };

    WrapperP2PFrame.prototype.isProxyRequest = function() {
      return window.location.pathname === "/";
    };

    WrapperP2PFrame.prototype.certSelectGotoSite = function(elem) {
      var href;
      href = $(elem).attr("href");
      if (this.isProxyRequest()) {
        return $(elem).attr("href", "http://p2p" + href);
      }
    };

    return WrapperP2PFrame;

  })();

  window.p2pframe = new WrapperP2PFrame(window.wrapper);
...
(function() {
  ...
  changeColorScheme = function(theme) {
    p2pframe.cmd("userGetGlobalSettings", [], function(user_settings) {
      if (user_settings.theme !== theme) {
        user_settings.theme = theme;
        p2pframe.cmd("userSetGlobalSettings", [user_settings], function(status) {
          if (status === "ok") {
            location.reload();
          }
        });
  ...
  displayNotification = function(arg) {
    ...
    p2pframe.cmd("siteInfo", [], function(site_info) {
      if (indexOf.call(site_info.settings.permissions, "ADMIN") >= 0) {
        p2pframe.cmd("wrapperNotification", ["info", "Your system's theme has been changed.<br>Please reload site to use it."]);
      } else {
        p2pframe.cmd("wrapperNotification", ["info", "Your system's theme has been changed.<br>Please restart the Peer-to-Peer Network client."]);
      }
    });
  };
