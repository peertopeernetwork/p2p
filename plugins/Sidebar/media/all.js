  ...
  Console = (function(superClass) {
    ...
    function Console(sidebar) {
      ...
      $(window).on("hashchange", (function(_this) {
        return function() {
          if (window.top.location.hash.startsWith("#Peer-to-Peer-Network:Console")) {
            return _this.open();
          }
        };
      })(this));
    ...
    Console.prototype.handleTabClick = function(e) {
      ...
      window.top.location.hash = "#Peer-to-Peer-Network:Console:" + elem.data("title");
      return false;
    };
...
(function() {
  ...
  Sidebar = (function(superClass) {
    ...
    function Sidebar(wrapper1) {
      ...
      if (window.top.location.hash === "#Peer-to-Peer-Network:OpenSidebar") {
        this.startDrag();
        this.moved("x");
