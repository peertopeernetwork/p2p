...
(function() {
  ...
  Text = (function() {
    ...
    Text.prototype.emailLinks = function(text) {
      return text.replace(/([a-zA-Z0-9]+)@p2p.bit/g, "<a href='?to=$1' onclick='return Page.message_create.show(\"$1\")'>$1@p2p.bit</a>");
    };

    Text.prototype.fixHtmlLinks = function(text) {
      if (window.is_proxy) {
        return text.replace(/href="http:\/\/(127.0.0.1|localhost):43110/g, 'href="http://p2p');
      } else {
    ...
    Text.prototype.fixLink = function(link) {
      var back;
      if (window.is_proxy) {
        back = link.replace(/http:\/\/(127.0.0.1|localhost):43110/, 'http://p2p');
        return back.replace(/http:\/\/p2p\/([^\/]+\.bit)/, "http://$1");
      } else {
  ...
  window.is_proxy = document.location.host === "p2p" || window.location.pathname === "/";
...
(function() {
  ...
  P2PFrame = (function(superClass) {
    extend(P2PFrame, superClass);

    function P2PFrame(url) {
    ...
    P2PFrame.prototype.init = function() {
      return this;
    };

    P2PFrame.prototype.connect = function() {
    ...
    P2PFrame.prototype.onMessage = function(e) {
      var cmd, message;
      message = e.data;
      cmd = message.cmd;
      if (cmd === "response") {
    ...
    P2PFrame.prototype.onRequest = function(cmd, message) {
      return this.log("Unknown request", message);
    };

    P2PFrame.prototype.response = function(to, result) {
      return this.send({
        "cmd": "response",
        "to": to,
        "result": result
    ...
    P2PFrame.prototype.cmd = function(cmd, params, cb) {
      if (params == null) {
        params = {};
      }
      if (cb == null) {
    ...
    P2PFrame.prototype.send = function(message, cb) {
      if (cb == null) {
        cb = null;
      }
    ...
    P2PFrame.prototype.onOpenWebsocket = function() {
      return this.log("Websocket open");
    };

    P2PFrame.prototype.onCloseWebsocket = function() {
    ...
    UiFileManager.prototype.init = function() {
      ...
      return this.cmd("siteInfo", {}, (function(_this) {
        return function(site_info) {
          _this.cmd("wrapperSetTitle", "List: /" + _this.list_inner_path + " - " + site_info.content.title + " - Peer-to-Peer Network");
